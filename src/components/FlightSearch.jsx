  ...
  const handleSearch = (e) => {
    ...
    if (tripType === 'multi-city') {
      ...
      if(origin && destination) {
        onSearch({ tripType, origin: origin.value, destination: destination.value, originLabel: origin.label, destinationLabel: destination.label, depTime: outDate, retTime: returnDate, passengers, directOnly, preferredAirline: preferredAirline ? preferredAirline.value : null });
      }
    }
  };
